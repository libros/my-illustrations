...
The bundled example images in `examples/images/` and `joel-article-illustrations/assets/examples/` were generated by Ian and are included as style calibration examples for this skill.
